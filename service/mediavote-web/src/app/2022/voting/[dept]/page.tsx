...
import { Head1, Head2, SmallText, Text, HyperLink, multiLine } from '@app/shared/article';
...
export default async function Page({ params }: NominationPageProps) {
  ...
  return (
    <div>
      ...
      <BallotSheet className="mt-8 mb-8" dept={dept} nominations={works} ballot={ballot} />
    </div>
  );
}
