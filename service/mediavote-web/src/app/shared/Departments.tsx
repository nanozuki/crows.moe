...
export const departments: DepartmentInfo[] = [
  {
    ...
    intro: (
      <Text>
        ...
        <HyperLink text="(wikipedia) 2022年日本动画列表" href="https://zh.wikipedia.org/wiki/日本動畫列表_(2022年)" />
        和
        <HyperLink text="(bangumi) 2022年动画" href="https://bangumi.tv/anime/browser/airtime/2022?sort=rank" />
      </Text>
    ),
  },
  {
    ...
    intro: (
      <Text>
        ...
        <HyperLink text="(bangumi) 2022年漫画" href="https://bangumi.tv/book/browser/comic/airtime/2022?sort=rank" />
        和
        <HyperLink text="(bangumi) 2022年小说" href="https://bangumi.tv/book/browser/novel/airtime/2022?sort=rank" />
      </Text>
    ),
  },
  {
    ...
    intro: (
      <Text>
        ...
        />
        和
        <HyperLink text="(bangumi) 2022年游戏列表" href="https://bangumi.tv/game/browser/airtime/2022?sort=rank" />
      </Text>
    ),
  },
];
